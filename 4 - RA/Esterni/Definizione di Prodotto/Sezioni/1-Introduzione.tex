...
\item \textbf{Documentazione can.js}: \link{https://canjs.com/doc/guides/contributing/documentation.html}
\item \textbf{Documentazione es6-event-emitter}: \link{https://www.npmjs.com/package/event-emitter-es6}
\item \textbf{Documentazione jQuery}: \link{https://api.jquery.com/}
\item \textbf{Documentazione Bootstrap}: \link{https://bootstrapdocs.com/}
\item \textbf{Documentazione Bootbox}: \link{http://bootboxjs.com/documentation.html}
\item \textbf{Documentazione Marked}: \link{https://github.com/chjj/marked}
