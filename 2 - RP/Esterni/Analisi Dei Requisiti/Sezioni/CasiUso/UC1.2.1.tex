...
\item\textbf{Scenario alternativo}:	
	\begin{itemize}
		\item Lo sviluppatore non inserisce del testo nella bolla o lo inserisce in modo non valido(UC 1.2.1.2).
		\item Lo sviluppatore non inserisce le dimensioni del bottone oppure le inserisce in modo non valido(UC 1.2.1.4).
		\item Lo sviluppatore non inserisce un colore di sfondo del bottone oppure lo inserisce in modo non valido(UC 1.2.1.6).
	\end{itemize}
