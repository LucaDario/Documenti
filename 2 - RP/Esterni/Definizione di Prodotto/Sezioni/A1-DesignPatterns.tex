...
\begin{itemize}
	...
	\item \textbf{Utilizzo}: all'interno di \progettoShort\ questo pattern viene utilizzato nella gestione grafica di tutte le \termine{bolle} e particolari altre viste inserite all'interno dell'applicazione.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
	  	...
	  	\item Strato \textbf{intermedio interno}: contiene gli \textit{use case}, ovvero quelle classi che compongono le regole logiche dell'applicazione e rappresentano il corrispettivo del Model nel modello \termine{Model View Presenter}.
