...
La forma più efficace per fare analisi dinamica è quella di progettare ed eseguire dei Test automatici. Essi fungono da ottimo strumento per la validazione del codice.
...
\item il \Pm{} ha il compito di revisionare i risultati dei test forniti dai \VerP{} e deve decidere se accettarli o ripeterli. In caso di dubbi su tale decisione, egli dovrà contattare il committente per poter arrivare al più presto ad una scelta. Nel caso in cui	il \Pm{} avesse già accettato l'esito dei test, egli dovrà comunque contattare il committente per comunicargli i risultati ottenuti.
\end{itemize}
