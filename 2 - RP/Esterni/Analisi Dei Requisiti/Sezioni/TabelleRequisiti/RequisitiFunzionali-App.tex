...
\endhead
			...
			\hline
			R1F4.1 & Deve essere possibile creare una bolla lista-spesa & Interno, UC4.1, UC4 \\
			\hline
			...
			\hline
			R1F4.3.1.5 & Deve essere possibile concedere i permessi a ad un utente a cui è stata pubblicata la bolla & Interno, UC4.3.1.4, UC4.3.1, UC 4.3 \\
			\hline
