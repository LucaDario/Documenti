...
\begin{figure}[H]
	\centering
	\includegraphics[width=16cm, height=14cm]{Sezioni/Diagrammi/SDK/Aggiungere un messaggio di completamento al widget Checklist.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm, height=8cm]{Sezioni/Diagrammi/SDK/Creazione di una bolla MarkDownBubble.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm, height=8cm]{Sezioni/Diagrammi/SDK/Creazione di una bolla AlertBubble.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm, height=8cm]{Sezioni/Diagrammi/SDK/Creazione di una bolla ToDoListBubble.png}
