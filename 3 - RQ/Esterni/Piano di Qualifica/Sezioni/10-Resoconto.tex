...
\hline
\endhead
\emph{Processo di fornitura} & \textcolor{Green}{3} & Superato & Ottimale\\ \hline
\emph{Processo di sviluppo} & \textcolor{Orange}{0} & Non superato & /\\ \hline
\emph{Validazione} & \textcolor{Orange}{0} & Non superato & /\\
\hline
\emph{Processo di documentazione} & \textcolor{Green}{2} & Superato & Accettabile\\ 
\hline
\emph{Processo di Configurazione} & \textcolor{Green}{1} & Superato & Accettabile\\ 
\hline
\emph{Processo di garanzia di qualità del Prodotto} & \textcolor{Green}{1} & Superato & Accettabile\\ 
\hline
\emph{Processo di Verifica} & \textcolor{Green}{1} & Superato & Accettabile\\ 
\hline
\emph{Processo di Validazione} & \textcolor{Green}{1} & Superato & Accettabile\\ 
\hline
\emph{Processo di Risoluzione dei problemi} & \textcolor{Green}{1} & Superato & Accettabile\\ 
\hline
