...
\begin{itemize}
	...
	\item If none of the above requirements is satisfied, the \app\ application can also be accessed from any mobile device using the \termine{Rocket.chat}'s mobile application.
\end{itemize}
