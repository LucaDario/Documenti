...
\end{itemize}
Verrà poi descritto sinteticamente l'\textit{ordine del giorno} dove verranno elencati sinteticamente tutti gli argomenti di cui si è discusso nel verbale.
Infine verrà descritta la decisione presa, essa sarà tracciata secondo il seguente schema \textit V(tipo)(codice). Dove:
\begin{itemize}
\item tipo: I se interno E se esterno;
\item codice: NumeroVerbale.IndiceDecisione, dove:
\begin{itemize}
\item NumeroVerbale: descrive il verbale in cui la decisione è stata presa;
\item IndiceDecisione: E' un indice di tipo gerarchico dove si indicizza la decisone, ad esempio decisione 5, sottodecisione 5.3 .
\end{itemize}
\end{itemize}
