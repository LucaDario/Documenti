...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|}
			...
			\textbf{Documento}	& \textbf{Risultato} & \textbf{Esito} & \textbf{Valore}\\
			\hline
		    \termine{Analisi} dei Requisiti v3.0.0 & 90 & Superato & Ottimale\\
			\hline
			Glossario v4.0.0 & 55 & Superato & Ottimale\\
			\hline
			Norme di Progetto v4.0.0 & 46 & Superato & Accettabile\\
			\hline
			Piano di Progetto v4.0.0 & 43 & Superato & Accettabile\\
			\hline
			Piano di Qualifica v4.0.0 & 45 & Superato & Accettabile\\
			\hline
		 \termine{Manuale Utente} \termine{Monolith} v2.0.0 & 59 & Superato & Ottimale\\
			\hline
		 \termine{Manuale Utente} Bringit v2.0.0 & 45 & Superato & Accettabile\\
            \hline
		\end{tabular}
	\end{center}
...
\emph{Test di \termine{Validazione} eseguiti} & {Percentuale} & \textcolor{Orange}{95\%} & / & Non superato & / \\ \hline
\emph{Test superati} & {Percentuale} & \textcolor{Green}{100\%} & / & Superato & Ottimale \\ \hline
