...
The first part is create a \termine{SDK}, called \textit{Monolith}, that allows the developer to create interactive bubbles easily. The interactive bubble, created using Monolith, has to be able to
work inside the \termine{Rocket.chat} environment.
The second part is create an application which works with \termine{Monolith} and uses the bubbles. Our application is called \termine{Bring-It} adn you can use it to create an interactive and sharable list.
