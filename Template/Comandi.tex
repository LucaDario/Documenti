...
\newcommand{\glossario}{\textit{\Gl\_v.4.0.0.pdf}}
\newcommand{\AdR}{Analisi dei Requisiti}
\newcommand{\analisiDeiRequisiti}{\textit{AnalisiDeiRequisiti\_v.3.0.0.pdf}}
\newcommand{\AdRvDue}{AnalisiDeiRequisiti}
\newcommand{\NdP}{Norme di Progetto}
\newcommand{\normeDiProgetto}{\textit{NormeDiProgetto\_v.4.0.0.pdf}}
\newcommand{\PdP}{Piano di Progetto}
\newcommand{\pianoDiProgetto}{\textit{PianoDiProgetto\_v.4.0.0.pdf}}
\newcommand{\SdF}{Studio di Fattibilità}
\newcommand{\studioDiFattibilita}{\textit{StudioDiFattibilita\_v.1.0.0.pdf}}
\newcommand{\PdQ}{Piano di Qualifica}
\newcommand{\pianoDiQualifica}{\textit{PianoDiQualifica\_v.4.0.0.pdf}}
\newcommand{\DDP}{Definizione di Prodotto}
\newcommand{\definizioneDiProdotto}{\textit{DefinizioneDiProdotto\_v.4.0.0.pdf}}
\newcommand{\MU}{Manuale Utente}
\newcommand{\manualeUtente}{\textit{MonolithUserManual\_v.2.0.0.pdf}}
\newcommand{\manualeUtenteApp}{\textit{BringItUserManual\_v.2.0.0.pdf}}
