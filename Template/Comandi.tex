...
\newcommand{\analisiDeiRequisiti}{\textit{\AdR\_v.3.0.0.pdf}}
\newcommand{\AdRvDue}{AnalisiDeiRequisiti}
\newcommand{\NdP}{Norme di Progetto}
\newcommand{\normeDiProgetto}{\textit{\NdP\_v.3.0.0.pdf}}
\newcommand{\PdP}{Piano di Progetto}
\newcommand{\pianoDiProgetto}{\textit{\PdP\_v.3.0.0.pdf}}
\newcommand{\SdF}{Studio di Fattibilità}
\newcommand{\studioDiFattibilita}{\textit{\SdF\_v.1.0.0.pdf}}
\newcommand{\PdQ}{Piano di Qualifica}
\newcommand{\pianoDiQualifica}{\textit{\PdQ\_v.3.0.0.pdf}}
\newcommand{\DDP}{Definizione di Prodotto}
\newcommand{\definizioneDiProdotto}{\textit{\DDP\_v.3.0.0.pdf}}
\newcommand{\MU}{Manuale Utente}
\newcommand{\manualeUtente}{\textit{\MU\_v.1.0.0.pdf}}
