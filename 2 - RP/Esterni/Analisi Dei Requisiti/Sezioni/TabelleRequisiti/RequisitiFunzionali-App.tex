...
\hline
\endhead
			R1F4 & Deve essere possibile creare ed utilizzare bolle lista-spesa  & Interno, UC4 \\
			\hline
			...
			\hline
			R1F4.2.5.7 & Se la quantità di prodotto non viene definita durante la sua modifica allora viene impostata la quantità al valore di default & Interno, UC4.2.5.7, UC4.2.5, UC4.2 \\
			\hline
			...
			\hline
			R1F4.3.1.3 & Se al momento della pubblicazione della lista ad un gruppo da parte del creatore della lista non vengono impostati i permessi ad alcun partecipante del gruppo allora non viene concesso nessun permesso ad alcun partecipante & Interno, UC4.3.1.3, UC4.3.1, UC 4.3 \\
			\hline
			R1F4.3.1.4 & Deve essere possibile pubblicare la lista-spesa ad un utente & Interno, UC4.3.1.4, UC4.3.1, UC 4.3 \\
			\hline
			R1F4.3.1.4 & Deve essere possibile concedere i permessi a ad un utente a cui è stata pubblicata la bolla & Interno, UC4.3.1.4, UC4.3.1, UC 4.3 \\
			\hline
			R1F4.3.1.6 & Se al momento della pubblicazione della lista ad un utente da parte del creatore della lista non vengono impostati i permessi per quell'utente allora all'utente non viene concesso nessun permesso & Interno, UC4.3.1.6, UC4.3.1, UC 4.3 \\
			\hline
			R1F4.3.1.3 & Se l'utente con permessi non viene impostato dal creatore della lista al momento della pubblicazione ad un gruppo allora i permessi vengono concessi a nessun partecipante & Interno, UC4.3.1.3, UC4.3.1, UC 4.3 \\
			\hline
			R1F4.3.2 & Deve essere possibile per utenti con permessi e per utenti senza permessi, ma non per utenti esterni, inoltrare la lista in sola lettura & Interno, UC4.3.2, UC4.3\\
			\hline
