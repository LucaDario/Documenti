...
\item\textbf{Scenario principale}:
	...
	\begin{itemize}
		\item Lo sviluppatore non inserisce un'immagine alla bolla oppure la inserisce in modo non corretto (UC 1.4.2).
		\item Lo sviluppatore non inserisce le dimensioni dell'immagine(UC 1.4.4).
	\end{itemize}
\end{itemize}
